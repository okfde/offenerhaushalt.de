...
Wenn Sie einen Haushalt auf dieser Seite einbinden wollen, beachten Sie bitte zunächst die Hinweise auf unserer [Mitmach-Seite](/page/mitmachen.html).

Pressekontakte oder persönliche Anfragen können auch direkt an die [Open
Knowledge Foundation Deutschland](mailto:info@okfn.de) und den Projektleiter
[Friedrich Lindenberg](http://pudo.org) gerichtet werden.
...
Seite [mit zu arbeiten](mitmachen), oder [unseren Trägerverein mit einer Spende zu
