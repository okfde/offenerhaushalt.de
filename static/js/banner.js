    ...
    if (dismissibles.length) {
        for (var i = 0; i < dismissibles.length; i++) {
            var type = dismissibles[i].getAttribute('data-type'),
                ...
                value = 'Mit <a style="color: #fff" href="https://offenerhaushalt.de">Offener Haushalt</a> sind wir in der letzten Runde der Google Impact Challenge. <a style="color: #fff; text-decoration: underline" href="https://impactchallenge.withgoogle.com/deutschland2018/charities/okfn">Stimme hier für uns ab!</a>'
